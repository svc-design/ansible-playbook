# Use a Debian-based image for compatibility with all tools
FROM debian:buster
...
# Define an entrypoint that lints Ansible, Go, YAML, React
ENTRYPOINT ansible-lint . && golint ./... && yamllint . && eslint "**/*.jsx"